...
export const DEFAULT_WORKSPACES = {
  app: {
    name: "Chat App (legacy)",
    path: "/home/loki/dev/aio/ai-tool-chat-minimal",
    readOnly: false,
  },
  currentPackage: {
  ...
  packages: {
    name: "Packages",
    path: "/home/loki/dev/aio/packages",
    readOnly: false,
  },
  fileBrowser: {
    name: "File Browser Component",
    path: "/home/loki/dev/aio/packages/file-browser",
    readOnly: false,
  },
  minihttp: {
    name: "Mini HTTP Server",
    path: "/home/loki/dev/aio/packages/minihttp",
    readOnly: false,
  },
  aiConsole: {
    name: "AI Console",
    path: "/home/loki/dev/aio/packages/ai-console",
    readOnly: false,
  },
  tasks: {
    name: "Tasks Component",
    path: "/home/loki/dev/aio/packages/tasks",
    readOnly: false,
  },
};
